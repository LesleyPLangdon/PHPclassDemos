...
/////////// go to https://www.w3schools.com/php/php_ref_overview.asp 

$testString = "WOW, that's amazing!!!";
...
echo str_pad("PHP", 30, "*^*_", STR_PAD_BOTH);
lb();
echo str_pad("PHP", 30, "*^*_", STR_PAD_RIGHT);
lb();
echo str_pad("PHP", 30, "*^*_", STR_PAD_LEFT);
lb();
...
echo substr_count($testString, "WOW");
lb();

echo strrev($testString);
lb();
